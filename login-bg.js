(function(){
  // 3D space background for Login page
  ...
  // Small Satellite (Matches the small moon at bottom-left of the main planet)
  ...
  function updateLayout() {
    ...
    if (w < 768) {
      ...
      // Tablet: Partially behind the card
      basePlanetX = -5.0;
      basePlanetY = -2.0;
      basePlanetZ = -28;
      ...
      // Desktop: Behind the card's edge, matching reference image layout
      basePlanetX = -7.5;
      basePlanetY = -3.0;
      basePlanetZ = -28;
